...
import bg from '@/public/images/test3.jpg'
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl lg:text-5xl  font-bold leading-tight">
                            ...
                            <span className="text-yellow-400">Design Services</span>
                        </h2>
                        <p className='font-[15px]'>Optimizify provides professional YouTube thumbnail design services. Our team of designers creates eye-catching thumbnails that align with your branding and capture attention in the crowded YouTube landscape.</p>

                        {/* Description */}
                        <div className="space-y-2 text-gray-300 text-sm lg:text-[20px]">
                            <div className="pt-4 space-y-4">
                                {[
                                    { feature: 'Brand Alignment', desc: 'Visuals and text aligned with your brand identity' },
                                    { feature: 'Content Accuracy', desc: 'Designs that accurately represent your video content' },
                                    { feature: 'Attention-Grabbing', desc: 'Eye-catching designs that stand out in YouTube feeds' },
                                ].map((item, index) => (
                                    <motion.div
                                        key={item.feature}
                            ...
                            >
                                <p className="text-gray-300 text-lg lg:text-xl">
                                    We ensure that your thumbnails <span className="text-yellow-400">capture attention, represent your content accurately,</span> and <span className="text-yellow-400">align with your brand</span>  for maximum impact.
                                </p>
                            </motion.div>
                        </div>
                    </motion.div>
